...
const Navbar = () => {
    return (
        <header className="text-gray-600 body-font">
            <div className="container mx-[192px] flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <ul className="lg:flex hidden items-center space-x-10">
                        ...
                        <li className="text-lg font-semibold hover:text-red-500 transition duration-200 cursor-pointer"><Link to="/booking">Online Booking</Link></li>
